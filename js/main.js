...
var SEARCH_INDEX = [
  ...
  { title: "5분 퀵스타트", url: "pages/quickstart-beginner.html", description: "프로그래밍 경험 없어도OK! 5분 만에 첫 Vibe Coding 프로젝트 완성", keywords: "vibe coding 빠른시작 초입문 5분 tutorial beginner quickstart 5분" },
  ...
  { title: "Markdown 스타일 가이드", url: "pages/markdown-style-guide.html", description: "일관된 Markdown 스타일과 문서 품질 체크리스트", keywords: "markdown 스타일 가이드 문서 품질 구조화" },
  ...
  { title: "LLM 개발 환경 구축", url: "pages/dev-environment.html", description: "터미널, 에디터, Git, CLI 도구를 포함한 LLM 개발 환경 설정 가이드", keywords: "llm 개발 환경 구축 터미널 에디터 git cli 설정" },

  // 🔌 LLM API & 연동
  { title: "LLM 생태계 개요", url: "pages/llm-landscape.html", description: "주요 LLM, API, 가격 비교", keywords: "llm landscape 생태계 개요 비교" },
  { title: "Claude API", url: "pages/claude-api.html", description: "Claude API 가이드 (인증, 메시지, 스트리밍, Tool Use)", keywords: "claude api anthropic 가이드 인증" },
  { title: "OpenAI API", url: "pages/openai-api.html", description: "OpenAI API 사용 흐름과 연동 가이드", keywords: "openai api 가이드 연동" },
  { title: "Codex", url: "pages/codex.html", description: "OpenAI Codex 개요, 작동 방식, 사용 흐름, 보안 고려사항", keywords: "codex openai 코딩 에이전트 워크플로우 보안" },
  ...
  { title: "Next.js", url: "pages/nextjs-vibe.html", description: "Next.js로 Vibe Coding 활용, App Router, Server Components", keywords: "Next.js Vibe Coding React SSR SSG" },
  { title: "Nuxt.js", url: "pages/nuxtjs-vibe.html", description: "Nuxt.js로 Vibe Coding 활용, Nuxt 3, SSR", keywords: "Nuxt.js Vibe Coding Vue 3 SSR" },
  { title: "Vue 3", url: "pages/vue3-vibe.html", description: "Vue 3 Composition API로 Vibe Coding 활용", keywords: "Vue 3 Vibe Coding Composition API" },
  { title: "Svelte/SvelteKit", url: "pages/svelte-vibe.html", description: "Svelte로 Vibe Coding 활용, 컴파일 방식", keywords: "Svelte SvelteKit Vibe Coding 컴파일" },
  { title: "Astro", url: "pages/astro-vibe.html", description: "Astro로 Vibe Coding 활용, Islands 아키텍처", keywords: "Astro Vibe Coding 정적사이트 Islands" },
  ...
  { title: "FastAPI", url: "pages/fastapi-vibe.html", description: "FastAPI로 Vibe Coding 활용, 비동기 Python", keywords: "FastAPI Vibe Coding Python 비동기" },
  { title: "Flask", url: "pages/flask-vibe.html", description: "Flask로 Vibe Coding 활용, 마이크로프레임워크", keywords: "Flask Vibe Coding Python 마이크로" },
  { title: "Django", url: "pages/django-vibe.html", description: "Django로 Vibe Coding 활용, 풀스택", keywords: "Django Vibe Coding Python 풀스택" },
  { title: "Express.js", url: "pages/express-vibe.html", description: "Express.js로 Vibe Coding 활용, Node.js", keywords: "Express Express.js Vibe Coding Node.js" },
  { title: "NestJS", url: "pages/nestjs-vibe.html", description: "NestJS로 Vibe Coding 활용, 의존성 주입", keywords: "NestJS Vibe Coding Node.js DI" },
  { title: "Fastify", url: "pages/fastify-vibe.html", description: "Fastify로 Vibe Coding 활용,고성능", keywords: "Fastify Vibe Coding Node.js 고성능" },

  // 🗄️ 기술 스택 - 데이터베이스
  { title: "데이터베이스 프롬프트", url: "pages/database-prompt.html", description: "데이터베이스 설계 및 SQL 생성 프롬프트", keywords: "database sql 프롬프트 설계" },
  { title: "PostgreSQL", url: "pages/postgresql-vibe.html", description: "PostgreSQL로 Vibe Coding 활용, RDBMS", keywords: "PostgreSQL Vibe Coding RDBMS ORM" },
  { title: "MongoDB", url: "pages/mongodb-vibe.html", description: "MongoDB로 Vibe Coding 활용, NoSQL", keywords: "MongoDB Vibe Coding NoSQL 문서" },
  { title: "Redis", url: "pages/redis-vibe.html", description: "Redis로 Vibe Coding 활용, 인메모리 캐시", keywords: "Redis Vibe Coding 인메모리 캐시" },
  { title: "SQLite", url: "pages/sqlite-vibe.html", description: "SQLite로 Vibe Coding 활용, 경량 DB", keywords: "SQLite Vibe Coding 경량 파일기반" },

  // ☁️ 기술 스택 - 인프라 & 클라우드
  { title: "Docker", url: "pages/docker-vibe.html", description: "Docker로 Vibe Coding 활용, 컨테이너", keywords: "Docker Vibe Coding 컨테이너 Docker Compose" },
  { title: "Kubernetes", url: "pages/kubernetes-vibe.html", description: "Kubernetes로 Vibe Coding 활용, 오케스트레이션", keywords: "Kubernetes K8s Vibe Coding 오케스트레이션" },
  { title: "AWS", url: "pages/aws-vibe.html", description: "AWS로 Vibe Coding 활용, 클라우드", keywords: "AWS Vibe Coding Amazon 클라우드 EC2 Lambda" },
  ...
  { title: "GPT를 밑바닥부터: microgpt.py 완전 해설", url: "pages/microgpt.html", description: "Andrej Karpathy의 microgpt.py — 순수 파이썬 200줄, 저자·데이터·Autograd·아키텍처·학습·Adam·추론·LLM 비교·수치 안정성·AdamW·샘플링·PyTorch 마이그레이션·디버깅·성능 분석·nanoGPT·build-nanogpt·FineWeb·GPT-2 재현까지 완전 해설", keywords: "microgpt karpathy gpt 밑바닥 autograd value 역전파 토크나이저 순수파이썬 micrograd 아키텍처 attention transformer 임베딩 rmsnorm mlp kv캐시 gpt2 weight-tying 학습 adam adamw 옵티마이저 크로스엔트로피 추론 temperature top-k top-p nucleus llm 비교 nanogpt pytorch 마이그레이션 수치안정성 디버깅 성능분석 lion 옵티마이저 lr스케줄러 repetition-penalty greedy-decoding 시간복잡도 build-nanogpt fineweb torch.compile flash attention gpt2 재현 openwebtext 파인튜닝 ddp 분산학습 cosine lr warmup modal lambda 클라우드 gpu" },
  ...
  { title: "Markdown vs HTML", url: "pages/markdown-vs-html.html", description: "Markdown과 HTML의 차이와 선택 기준", keywords: "markdown html 비교 선택 기준" },
...
var NAV_STRUCTURE = [
  ...
  { title: '📝 프롬프트 엔지니어링', pages: [
    ...
    { file: 'markdown-style-guide.html', title: 'Markdown 스타일 가이드' }
  ]},
  { title: '💻 AI CLI 도구들', pages: [
    { file: 'cli-tools-overview.html', title: 'AI CLI 도구 생태계' },
    { file: 'dev-environment.html', title: 'LLM 개발 환경 구축' },
  ...
  { title: '🔌 LLM API & 연동', pages: [
    ...
    { file: 'claude-api.html', title: 'Claude API' },
    { file: 'openai-api.html', title: 'OpenAI API' },
    { file: 'codex.html', title: 'Codex' },
  ...
  { title: '📖 참고 & 리소스', pages: [
    ...
    { file: 'markdown-vs-html.html', title: 'Markdown vs HTML' },
  ...
  function ensureSvgAccessibility() {
    ...
    svgs.forEach(svg => {
      ...
      if (figure) {
        ...
        if (figcaption) label = figcaption.textContent.trim();
      }

      if (!label) {
        const next = svg.nextElementSibling;
        if (next && next.classList.contains('diagram-caption')) {
          label = next.textContent.trim();
        }
      }

      if (!label) {
        const wrapper = svg.closest('.diagram-container');
        if (wrapper) {
          const wrapperNext = wrapper.nextElementSibling;
          if (wrapperNext && wrapperNext.classList.contains('diagram-caption')) {
            label = wrapperNext.textContent.trim();
          }
        }
      }

      if (!label) {
        const section = svg.closest('.content-section');
        if (section) {
          const heading = section.querySelector('h2, h3');
          if (heading) label = heading.textContent.trim() + ' 다이어그램';
        }
      }

      svg.setAttribute('aria-label', label || '다이어그램');
    });
  }

  // ========== 다이어그램 레이아웃 보강 ==========

  function optimizeDiagramLayout() {
    const svgs = document.querySelectorAll('.main-content svg');
    svgs.forEach(svg => {
      if (!svg.closest('.diagram-container') && !svg.closest('figure')) {
      ...
      if (width >= 700) {
        svg.classList.add('diagram-wide');
      }
    });
  }
